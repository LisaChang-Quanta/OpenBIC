...
#define XDPP1100_READ_VOUT_EXP_VALUE (1.0 / (1 << 12)) //2^(-10)

LOG_MODULE_REGISTER(xdpp1100);

uint8_t xdpp1100_read(sensor_cfg *cfg, int *reading)
{
	...
	if (cfg->offset == PMBUS_READ_VOUT) {
		...
		val = read_value * XDPP1100_READ_VOUT_EXP_VALUE;
...
uint8_t xdpp1100_init(sensor_cfg *cfg)
{
